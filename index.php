...
<title>GARENA GIFT - FREE FIRE SKINS</title>
    <meta name="description" content="Get New Card From SUPERCELL and get the biggest prize in 2018-2019.">
<!DOCTYPE html>
<html lang="zh">
...
</div><span class="txt_c_1">Important Notice:</span><div class="more"><ol><li><!-- react-text: 18 -->1. Redemption Code<!-- /react-text --><span class="colorUo"> 12 </span><!-- react-text: 20 --> Characters, consisting of uppercase letters and numbers.<!-- /react-text --></li>
<li><!-- react-text: 22 -->2. Gift items displayed in<!-- /react-text --><span class="colorUo">&nbsp;[vault]&nbsp;</span><!-- react-text: 24 -->Tab in game lobby Gold or diamond will be added to the Account Wallet automatically.<!-- /react-text --></li>
<li>3. Please note the due date of redemption. The expired code cannot be exchanged.</li>
<li>4. Please contact customer service if you experience any problems.</li>
<li>5. Reminder: You will not be able to redeem your prize with a guest account. You can bind your account to Facebook or VK to receive prizes.</li></ol>
<center><a href="choose.html" class="button"><img src="imgg/button.png" </center>
</div></div></div></div>
